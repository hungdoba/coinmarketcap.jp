// Number Handler
// This module provides utility functions for formatting and manipulating numbers.
// - formatNumber: Formats a number with commas as thousands separators and an optional sign (e.g., 1,234.56).
// - roundDecimals: Rounds a number to a specified number of decimal places.
// - shortenNumber: Shortens a large number by adding a postfix (e.g., "1.23M" for 1,230,000).

export const formatNumber = (
  x: number | null,
  removeNegativeSign: boolean = false
) => {
  if (x === null) return '0';
  let num: number = x;
