                ...
                ? [
                    {
                      ...
                      content: `${
                        marketData.priceChange24HInCurrency.usd > 0 ? '+' : '-'
                      }$${formatNumber(
                        marketData.priceChange24HInCurrency.usd,
                        true
                      )}`,
                ...
                ? [
                    {
                      ...
                      )} / $${formatNumber(marketData.high24H.usd)}`,
                    },
                  ]
                : []),
          ...
          },
          {
            ...
            items: [
                ...
                ? [
                    {
                      name: '7D Change',
                      content: `${
                        marketData.priceChangePercentage7DInCurrency.usd > 0
                          ? '+'
                          : ''
                      }${roundDecimals(
                        marketData.priceChangePercentage7DInCurrency.usd
                ...
                ? [
                    {
                      name: '14D Change',
                      content: `${
                        marketData.priceChangePercentage14DInCurrency.usd > 0
                          ? '+'
                          : ''
                      }${roundDecimals(
                        marketData.priceChangePercentage14DInCurrency.usd
                ...
                ? [
                    {
                      name: '30D Change',
                      content: `${
                        marketData.priceChangePercentage30DInCurrency.usd > 0
                          ? '+'
                          : ''
                      }${roundDecimals(
                        marketData.priceChangePercentage30DInCurrency.usd
                ...
                ? [
                    {
                      name: '60D Change',
                      content: `${
                        marketData.priceChangePercentage60DInCurrency.usd > 0
                          ? '+'
                          : ''
                      }${roundDecimals(
                        marketData.priceChangePercentage60DInCurrency.usd
                ...
                ? [
                    {
                      name: '200D Change',
                      content: `${
                        marketData.priceChangePercentage200DInCurrency.usd > 0
                          ? '+'
                          : ''
                      }${roundDecimals(
                        marketData.priceChangePercentage200DInCurrency.usd
                ...
                ? [
                    {
                      name: '1Y Change',
                      content: `${
                        marketData.priceChangePercentage1YInCurrency.usd > 0
                          ? '+'
                          : ''
                      }${roundDecimals(
                        marketData.priceChangePercentage1YInCurrency.usd
              ...
              ...(marketData.ath.usd && marketData.athDate.usd
                ? [
                    {
                      name: `All Time High (${convertIsoString(
              ...
              ...(marketData.atl.usd && marketData.atlDate.usd
                ? [
                    {
                      name: `All Time Low (${convertIsoString(
                  ...
                  items: [
                    {
                      ...
                      content: `$${formatNumber(
                        marketData.totalValueLocked.usd
                      )}`,
                    },
                    ...(marketData.marketCap.usd
                      ? [
