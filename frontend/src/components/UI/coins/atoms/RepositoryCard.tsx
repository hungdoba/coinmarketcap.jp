          ...
          <Grid container spacing={0} className={classes.dataContainer}>
            ...
            <Grid item xs={3}>
              ...
              >
                ...
                <StatsNumberSection
                  title="Contributors"
                  value={
                    coinDetails.value.developerData.pullRequestContributors
                  }
                />
                <StatsNumberSection
            ...
            <Grid item xs={6}>
              <Box height="100%" display="flex" flexDirection="column">
                <Box paddingLeft={3} paddingRight={3}>
                  ...
                  <List dense>
                    <ListItem>
                      ...
                      <ListItemText
                        primary={
                          coinDetails.value.developerData.commitCount4Weeks ||
                          '-'
                        }
                    ...
                    <ListItem>
                      ...
                      <ListItemText
                        primary={
                          coinDetails.value.developerData
                            .codeAdditionsDeletions4Weeks.additions
                    ...
                    <ListItem>
                      ...
                      <ListItemText
                        primary={
                          coinDetails.value.developerData
                            .codeAdditionsDeletions4Weeks.deletions || '-'
                        }
                        primaryTypographyProps={{ align: 'right' }}
                ...
                {coinDetails.value.developerData.last4WeeksCommitActivitySeries
                  .length > 0 ? (
                  <Box flex="1">
