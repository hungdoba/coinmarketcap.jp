    ...
    <Grid container spacing={3} className={classes.container}>
      <Grid item xs={4}>
        <LargeProgressCard
          ...
          value={coinDetails.value?.communityScore || 0}
        />
      </Grid>
      <Grid item xs={4}>
        <SocialCard
          ...
          <Box flex="1">
            ...
            >
              ...
              <StatsNumberSection
                ...
                value={
                  coinDetails.value?.communityData.redditAverageComments48H
                }
              />
            </Box>
          </Box>
        ...
        <Grid container className={classes.innerWrapper} spacing={0}>
          <Grid item xs={12}>
            <SocialCard
              ...
              iconColor="#3b5998"
              link={
                coinDetails.value?.links.facebookUsername
                  ? `https://www.facebook.com/${coinDetails.value.links.facebookUsername}`
                  : null
              }
            >
              <Box
          ...
          <Grid item xs={12}>
            <SocialCard
              ...
              iconColor="#00acee"
              link={
                coinDetails.value?.links.twitterScreenName
                  ? `https://twitter.com/${coinDetails.value.links.twitterScreenName}`
                  : null
              }
            >
              <Box
