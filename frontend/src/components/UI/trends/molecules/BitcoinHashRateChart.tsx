      ...
      {bitcoinHashRate.value.length === 0 ? (
        ...
        >
          ...
          >
            <defs>
              <linearGradient
                id="bitcoin-hash-rate-chart-gradient"
                x1="0"
                y1="0"
                x2="0"
                y2="1"
                  ...
                  return (
                    <Box className={classes.customTooltip}>
                      ...
                      <Typography variant="body2" color="secondary">
                        Hash Rate: {shortenNumber(payload[0].payload.value)}{' '}
                        TH/s
                      </Typography>
                      {bitcoinHashRate.showBitcoinCorrelation && (
                        <Typography variant="body2" id="bitcoin-tooltip">
                          Bitcoin Price: US$
                          {roundDecimals(payload[0].payload.bitcoinPrice, 0)}
                        </Typography>
                      )}
                    </Box>
                  );
